...
const JD = ({img, name, url, about, ...card}) => {
  console.log('card: ', card);
  console.log('staticCards[0]', staticCards[0])
  ...
  // type: "major"
  // value: "1"
  const cardsWithPhotos = staticCards.map(card => card.type === 'major' 
    ? `https://www.biddytarot.com/wp-content/uploads/2018/06/ET-MA-${value}-${card.name.replace(/\s+/g, '-')}.jpg`
    : `https://www.biddytarot.com/wp-content/uploads/2018/06/ET-${card.name.toUpperCase()}-${value}.jpg` 
  )
  return (
